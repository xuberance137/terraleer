# Adapted from Robert Wilson's converter code @ https://github.com/robintw/LatLongToWRS
...
class ConvertToWRS:
    ...
    * Shapely
    * Landsat WRS-2 Path/Row Shapefiles - download from USGS site for shape boundaries
    ...
    def __init__(self, shapefile="../data/Shapefile/wrs2_descending/wrs2_descending.shp"):
